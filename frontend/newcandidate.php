...
$mks=$_POST["mk"];
include "../web_db/connection.php";
$querycheck=mysqli_query($conn,"select posts.postid,posts.postname,candidates.cnid,candidates.fastname,candidates.lastname,candidates.gender,candidates.Date_of_birth,candidates.Post_id,candidates.Exam_date,candidates.Phone_number,candidates.Marks from posts inner join candidates on posts.Postid=candidates.Post_id where candidates.cnid='$cnid' and posts.postname='$pname'");
...
{
$queryinsert=mysqli_query($conn,"insert into candidates values('','$cnid','$fname','$lname','$gender','$dob','$pid','$doe','$phone','$mks')");
if ($queryinsert) 
{
